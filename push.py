    ...
    def extract_link_code():
        ...
        if request.status_code == 200:
            ...
            for tr in trs:
                ...
                info_extracted.append(link_code_extracted)
                # info_extracted.append(text_extracted)
    ...
    def extract_text():
        ...
        if request.status_code == 200:
            ...
            for tr in trs:
                ...
                # result.append(notice_info)
                texts_extracted.append(text_extracted)                    
        else:
            print("cannot access to site.")
        
        return texts_extracted
    
# pusher.extract_code_max()    
# pusher.extract_link_code()
